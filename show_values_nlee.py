...
Original code written by Gabriel Dima, small edits made by Nick Lee
...
def get_weather():
    ...
    filename='catalogs/napa_model_wind_Aug.txt'
    ...
    #filename_machine='catalogs/napa_model_Aug_full_ml60.txt'  # Recalibrate model every day
    #filename_machine='catalogs/napa_model_Aug_recheck5_ml60.txt'  # Recalibrate model every 5 days
    filename_machine='catalogs/napa_model_Aug_recheck99_ml60.txt'  # Never recalibrate model
